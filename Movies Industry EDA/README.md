...
We will also create two columns called `Adjusted_Budget` and `Adjusted_Profit` where we recalculate a movie's budget and profit to account for inflation and allow us to perform analysis based on the value of the 2025 dollar.
...
**Question 1 Conclusion:** Our Company should budget \$90,335,000 for a movie and that budget should correlate with a profit margin of 83\%.
...
![NetProfitByGenre.png](visuals/NetProfitByGenre.png)

![ProfitMarginByGenre](visuals/ProfitMarginByGenre.png)
...
![ProfitMarginByReleaseMonth](visuals/ProfitMarginByReleaseMonth.png)
...
![NetProfitByMonthByGenre](visuals/NetProfitByMonthByGenre.png)
...
![VAR By Actor Compared to Avgerage](visuals/VAR_By_ActorCompared_to_AVGt.png)

![VAR By Director Compared to Average](visuals/VAR_By_DirectorCompared_to_AVG.png)
...
![Oscar_Nominated](visuals/Distribution_of_Movie_Budgets_for_Profitable_Oscar_Nominated_Movies.png)
...
![3_Nominations](visuals/Distribution_of_Movie_Budgets_for_Movies_With_At_Least_three_Nominations.png)

**Question 5 Conclusion:** Our Company should spend at least $38,865,600 in order to make an Oscar-winning movie.
...
![ProfitbyGenrebyRating](visuals/Net_Profit_By_Genre_By_Ratin.png)
...
![NetProfitStudio](visuals/Median_Net_Profit_By_Studio.png)
...
![Average Domestic Gross Per Theater](visuals/Average_Domestic_Gross_Per_Theater.png)


We also investigate the correlation between the average maximum number of theaters and average domestic gross per studio.

![TheatersVGross](visuals/Maximum_Number_of_Theaters_Vs_Domestic_Gross.png)
